(function() {
  ...
  */
      ...
      if (params && params.version) {
        ...
        (this.classLoader = new ClassLoader(__bind(function(cls, c) {
          ...
          return this.InitializeSystem(__bind(function() {
            return this.load(this.mainclassname, false, null, this.settings.end);
          }, this));
        }, this))).init();
  ...
  this.CONSTANT_int = (function() {
    __extends(CONSTANT_int, JVM_Number);
    ...
    RDA.prototype.addClass = function(classname, raw_class, instantiatedCallback, threadFinishedCallback) {
      ...
      return this.clinit(classname, raw_class, __bind(function() {
        ...
        if (classname === this.JVM.mainclassname) {
          ...
          this.createThread(classname, method, null, threadFinishedCallback);
        }
      ...
      return this.JVM_ResolveClass('java/lang/String', __bind(function(cls) {
        ...
        if (!this.JVM_InternedStrings[literal]) {
          ...
          return this.JVM_NewObject(cls, method, [], __bind(function(stringobj) {
            this.JVM_FromHeap(stringobj).count = new CONSTANT_integer(literal.length);
            this.RDA.heap.update(this.JVM_FromHeap(stringobj).value, charArray);
            this.JVM_FromHeap(stringobj).colour = 3;
  ...
  this.GC = (function() {
    ...
    GC.prototype.reclaim = function() {
      ...
      for (index in this.heap.younggen) {
        ...
        if (item.colour === this.white) {
          delete this.heap.younggen[index];
        }
      }
      return true;
    };
    ...
    GC.prototype.add = function(rootobjects) {
      ...
      if (++this.responses === this.threadcount) {
        this.run();
      }
      return true;
    };
